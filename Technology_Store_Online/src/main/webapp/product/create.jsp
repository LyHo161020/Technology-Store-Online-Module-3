                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h2 class="page-title">Creat Product</h2>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="mt-4 mt-lg-0">
                                        <h3 class="header-title"><i>
                                            Enter product information you want to add</i></h3>
                                        ...
                                        <form role="form" class="parsley-examples" data-parsley-validate="" novalidate="">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <select id="type" class="form-select valid form-control" name="recipientName" aria-invalid="false">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input id="name" type="text" placeholder="Name" required="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="number" required="" placeholder="Amount" class="form-control" id="amount">
                                                </div>
                                            </div>
